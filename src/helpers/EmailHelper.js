...
class EmailHelper {
  constructor(options = {}) {
    ...
    this.defaultSender =
      ...
      "noreply@edumanage.com";
    // this.defaultSender = options.defaultSender || {
    //   email: process.env.DEFAULT_SENDER_EMAIL || 'noreply@edumanage.com',
    //   name: process.env.DEFAULT_SENDER_NAME || 'EduManage'
    // };
...
const emailResult = await emailHelper.sendEmail({
  ...
  htmlContent: '<h1>Welcome!</h1><p>Thank you for joining EduManage.</p>',
  textContent: 'Welcome! Thank you for joining EduManage.'
});
